    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid" style="height:100%">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit Peminjaman Ruangan</h1>
                    </div>
                </div>
                <!-- /.row -->
                <!-- /.row -->
            ...
            <form role="form" action="/admin/updatepeminjaman" method="POST">
                ...
                <div class="form-group">
                    <select name="ruang" class="form-control" value="{{$data[0]->nama_ruangan}}">
                        @foreach($ruangan as $ruang)
                        @if($ruang->nama_ruangan===$data[0]->nama_ruangan)
                        @then
                        <option selected="selected" value="{{$ruang->nama_ruangan}}" >{{$ruang->nama_ruangan}}</option>
                        @else
