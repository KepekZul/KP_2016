    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid" style="height:100%">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Daftar Peminjaman Ruangan</h1>
                    </div>
                </div>
                <!-- /.row -->
                <!-- /.row -->
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="suntingpeminjaman/{{$list->kode_permohonan}}"><button name="kode_permohonan" value="{{$list->kode_permohonan}}" class="btn btn-sm btn-success">Sunting</button></href></td>
