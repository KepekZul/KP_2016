...
Route::get('/dosen/editjadwaldosen/{id}', 'dosenController@editjadwaldosen')->middleware('dosen');
...
Route::post('/dosen/editrutin', 'dosenController@editRutin')->middleware('dosen');
Route::get('/dosen/hapusrutin/{id}', 'dosenController@hapusRutin')->middleware('dosen');
...
Route::get('/lihatdosen/rutin/{kunci}', 'umumController@data2');
